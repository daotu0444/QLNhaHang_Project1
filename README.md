...
Lời đầu tiên, nhóm The Deamers xin gửi lời cảm ơn trân trọng nhất đến Thầy **Hoàng Văn Thông** – giảng viên môn Lập trình Java đã tận tình giúp đỡ, trực tiếp chỉ bảo, với sự hướng dẫn và những ý kiến quý báu của thầy đã giúp nhóm chúng em hoàn thành được đồ án môn học của mình một cách hoàn thiện.
...
## Nhóm Thực Hiện : Nhóm 9

| MSSV | Họ tên   | 
| :-------- | :------- | 
| 2152279 | Đào Minh Tú |
|21520400 | Đoàn Mạnh Cường |
| 21520190| Dương Ngọc Doanh |
...
> * **Bước 1:** Clone project [Java_Project_RestaurantMS](https://github.com/daotu0444/QLNhaHang_Project1.git)
...
> * **Bước 4:** Trong src/DataBase có file Database.sql. Tiến hành vào Oracle tạo user mới với Username là `system` và Password là `daotu123`, sau đó chạy toàn bộ file Database.sql.
