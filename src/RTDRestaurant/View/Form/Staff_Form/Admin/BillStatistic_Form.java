...
public class BillStatistic_Form extends javax.swing.JPanel {
    ...
    // ✅ Thư mục tuyệt đối
    String folderPath = "D:\\ExportFile_Excel";
    File folder = new File(folderPath);
    if (!folder.exists()) folder.mkdirs();

    // ✅ Lưu file vào ổ D
    String filePath = folderPath + "\\DanhsachHoaDon_" + simpleDateFormat.format(new Date()) + ".xlsx";
    workbook.easy_WriteXLSXFile(filePath);

    // ✅ Đóng workbook đúng thứ tự
    workbook.Dispose();

    // ✅ Gọi lại ExportFileSuccess
    File file = new File(filePath);
    String path = file.getAbsolutePath();
    System.out.println("✅ Đã xuất file Excel tại: " + path);
